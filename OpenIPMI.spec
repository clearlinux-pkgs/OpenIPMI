...
Version  : 2.0.37
Release  : 50
URL      : https://sourceforge.net/projects/openipmi/files/OpenIPMI%202.0%20Library/OpenIPMI-2.0.37.tar.gz
Source0  : https://sourceforge.net/projects/openipmi/files/OpenIPMI%202.0%20Library/OpenIPMI-2.0.37.tar.gz
...
%prep
%setup -q -n OpenIPMI-2.0.37
cd %{_builddir}/OpenIPMI-2.0.37
pushd ..
cp -a OpenIPMI-2.0.37 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745877637
...
/usr/include/OpenIPMI/sysinfo.h
