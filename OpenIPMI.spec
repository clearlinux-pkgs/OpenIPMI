...
%prep
%setup -q -n OpenIPMI-2.0.28
cd %{_builddir}/OpenIPMI-2.0.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576523393
...
cp %{_builddir}/OpenIPMI-2.0.28/COPYING.BSD %{buildroot}/usr/share/package-licenses/OpenIPMI/6041dfa4b268e7399d2c7e18c644cb291982028a
cp %{_builddir}/OpenIPMI-2.0.28/COPYING.LIB %{buildroot}/usr/share/package-licenses/OpenIPMI/cf756914ec51f52f9c121be247bfda232dc6afd2
%make_install
