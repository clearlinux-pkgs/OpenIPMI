...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637095289
...
cp %{_builddir}/OpenIPMI-2.0.32/COPYING %{buildroot}/usr/share/package-licenses/OpenIPMI/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/OpenIPMI-2.0.32/COPYING.BSD %{buildroot}/usr/share/package-licenses/OpenIPMI/6041dfa4b268e7399d2c7e18c644cb291982028a
cp %{_builddir}/OpenIPMI-2.0.32/COPYING.LIB %{buildroot}/usr/share/package-licenses/OpenIPMI/cf756914ec51f52f9c121be247bfda232dc6afd2
%make_install
