...
Source0  : https://sourceforge.net/projects/openipmi/files/OpenIPMI%202.0%20Library/OpenIPMI-2.0.35.tar.gz
...
%prep
%setup -q -n OpenIPMI-2.0.35
cd %{_builddir}/OpenIPMI-2.0.35
pushd ..
cp -a OpenIPMI-2.0.35 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714497047
