...
Source0  : https://sourceforge.net/projects/openipmi/files/OpenIPMI%202.0%20Library/OpenIPMI-2.0.30.tar.gz
...
%prep
%setup -q -n OpenIPMI-2.0.30
cd %{_builddir}/OpenIPMI-2.0.30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607540864
...
cp %{_builddir}/OpenIPMI-2.0.30/COPYING %{buildroot}/usr/share/package-licenses/OpenIPMI/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/OpenIPMI-2.0.30/COPYING.BSD %{buildroot}/usr/share/package-licenses/OpenIPMI/6041dfa4b268e7399d2c7e18c644cb291982028a
cp %{_builddir}/OpenIPMI-2.0.30/COPYING.LIB %{buildroot}/usr/share/package-licenses/OpenIPMI/cf756914ec51f52f9c121be247bfda232dc6afd2
%make_install
